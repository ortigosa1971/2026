...
// Migración suave (por si la BD ya existía sin device_id)
try {
...
app.post('/login', async (req, res) => {
  try {
    const { usuario, username, password, device_id } = req.body;
    ...
    // Si el usuario ya está “atado” a un dispositivo distinto, se bloquea
